...
const FullPageEditor = () => {
  ...
  const loadArticle = async (id) => {
    try {
      ...
      setContent(article.content_html || '<h1>Your Article Title</h1><p>Start writing...</p>');
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      const articleData = {
        ...
        meta_description: articleSettings.excerpt || finalTitle
      };
      ...
      setError(error.response?.data?.message || error.message || 'Failed to publish article');
    } finally {
